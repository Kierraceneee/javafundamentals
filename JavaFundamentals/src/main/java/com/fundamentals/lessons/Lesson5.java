...
public class Lesson5 {
    ...
    * is Short. */
    ...
    /* This primitive type has a value range of
    * -2,147,483,648 to 2,147,647. The class version
    * of this primitive is Integer. */
    int myInt = 2354;

    /* This primitive type has a value range of
    -9,223,372,036,854,775,808 to 9,223,372,036,775,807.
    ...
    * */
    ...
    This suffix of f or F is needed to separate it from double.
    ...
    * this primitive is Double. */
    ...
    public void showLocalexample(){
        ...
        // uses local scope over instance scope.
    ...
    * two data types convert , but require a direct
    * boxing effect. This is because a larger data type is
    * converting to a smaller one, which will have precision loss. */
    public void convertExplicitly () {
        long sample2 = (long)myDouble; //84.98
        int sample3 = (int)usingUnderscores; //4_568_987_367L
