...
public class Lesson16 {
    ...
    public void filterLambda(){
        ...
        Stream<House> filterHouse = houses.stream().filter(houseChoice -> houseChoice.
                getEntranceDoorColor().equals("Grey"));
        filterHouse.forEach(house -> System.out.println("Selections " + house.toString()));
    }

    /* Filter using Predicate Interface and Lambda */
    public void queryInfo(ArrayList<CompanyInfo> company, Predicate<CompanyInfo> expr){ // expr = expression
    ...
    public static void main(String[] args){
        ...
        myLesson.queryInfo(Lesson16.getCompanyInfo(), (id -> id.getId() < 2000));
    }
